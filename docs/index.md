...
- **Open source** — MIT licensed, artifacts on Maven Central (`org.qavo`) and npm (`@qavo`).
...
|---|---|
| [Architecture](architecture) | Full reference architecture: technology choices, layers, cross-cutting concerns, plugin model, theming, mobile-first design |
| [Contributing](contributing) | How to contribute to Qavo |
| [Security](security) | Security policy and vulnerability reporting |
...
Qavo is designed and built with the assistance of artificial intelligence. AI tools are used for architecture design, code generation, and documentation. Every decision and released artifact is reviewed and owned by human maintainers. See the [full disclosure](architecture#12-ai-assisted-development-disclosure) in the architecture document.

---

## License

Qavo is released under the [MIT License](https://github.com/davidfriscia/qavo/blob/main/LICENSE).
Copyright &copy; 2026 David Friscia.
